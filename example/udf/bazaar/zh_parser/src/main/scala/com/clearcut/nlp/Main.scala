...
object Main extends App {
    ...
    case class Config(serverPort: Integer = null,
                    ...
                    annotators: String = "tokenize, cleanxml, ssplit, pos, ner, parse")
    ...
    //java.util.Properties implements Map in Java
    val props = new Properties()
    props.put("annotators", conf.annotators)
    props.put("parse.maxlen", conf.maxSentenceLength)
    props.put("model", "/home/yomin/spouse_example-0.8-STABLE/udf/bazaar/zh_parser/lib/models/")
